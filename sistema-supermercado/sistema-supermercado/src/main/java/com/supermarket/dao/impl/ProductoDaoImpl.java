...
public class ProductoDaoImpl extends DatabaseDao implements ProductoDao {
    ...
    public boolean save(Producto p) {
        String sql = "INSERT INTO productos (sku, nombre, descripcion, precio, categoria_id) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean update(Producto p) {
        String sql = "UPDATE productos SET sku=?, nombre=?, descripcion=?, precio=?, categoria_id=? WHERE id=?";
